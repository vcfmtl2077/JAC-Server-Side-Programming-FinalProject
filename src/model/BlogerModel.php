...
{
    $stmt = $GLOBALS['dbconn']->prepare("Select * from Bloger where Bloger_id=?");
...
{
    $stmt = $GLOBALS['dbconn']->prepare("INSERT INTO Bloger (blog_id, title, content, author ,publish_date) 
    VALUES (?, ?,?,?,?)");
